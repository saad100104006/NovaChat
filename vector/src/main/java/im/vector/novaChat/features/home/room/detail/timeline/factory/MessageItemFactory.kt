...
import im.vector.novaChat.core.utils.containsOnlyEmojis
import im.vector.novaChat.core.utils.isLocalFile
...
import im.vector.novaChat.features.home.room.detail.timeline.helper.TimelineMediaSizeProvider
import im.vector.novaChat.features.home.room.detail.timeline.item.AbsMessageItem
import im.vector.novaChat.features.home.room.detail.timeline.item.MessageBlockCodeItem
import im.vector.novaChat.features.home.room.detail.timeline.item.MessageBlockCodeItem_
import im.vector.novaChat.features.home.room.detail.timeline.item.MessageFileItem
import im.vector.novaChat.features.home.room.detail.timeline.item.MessageFileItem_
import im.vector.novaChat.features.home.room.detail.timeline.item.MessageImageVideoItem
import im.vector.novaChat.features.home.room.detail.timeline.item.MessageImageVideoItem_
import im.vector.novaChat.features.home.room.detail.timeline.item.MessageInformationData
import im.vector.novaChat.features.home.room.detail.timeline.item.MessageOptionsItem_
import im.vector.novaChat.features.home.room.detail.timeline.item.MessagePollItem_
import im.vector.novaChat.features.home.room.detail.timeline.item.MessageTextItem
import im.vector.novaChat.features.home.room.detail.timeline.item.MessageTextItem_
import im.vector.novaChat.features.home.room.detail.timeline.item.RedactedMessageItem
import im.vector.novaChat.features.home.room.detail.timeline.item.RedactedMessageItem_
import im.vector.novaChat.features.home.room.detail.timeline.item.VerificationRequestItem
import im.vector.novaChat.features.home.room.detail.timeline.item.VerificationRequestItem_
...
import im.vector.novaChat.features.html.CodeVisitor
