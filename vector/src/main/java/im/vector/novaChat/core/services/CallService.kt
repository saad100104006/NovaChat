...
class CallService : VectorService() {
    ...
    companion object {
        ...
        private const val ACTION_INCOMING_CALL = "im.vector.novaChat.core.services.CallService.INCOMING_CALL"
        private const val ACTION_PENDING_CALL = "im.vector.novaChat.core.services.CallService.PENDING_CALL"
        private const val ACTION_NO_ACTIVE_CALL = "im.vector.novaChat.core.services.CallService.NO_ACTIVE_CALL"
